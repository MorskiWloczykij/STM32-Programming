...
#define IDLE_STACK_START	((SRAM_END) - (4 * SIZE_TASK_STACK)) //address of fourth task stack

#define SCHED_STACK_START	((SRAM_END) - (5 * SIZE_TASK_STACK))  //address of scheduler stack
